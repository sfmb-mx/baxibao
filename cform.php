        ...
        <div class="wrap">
            <div class="ml-header">
                <div class="ml-header-inner">
                    <h1>
                        <a href="index.html">
                            <img height="35" src="img/logo_transparent.png">
                    </h1>
                        </a>
                        <div class="cbt-header-links">
                            <ul>
                                ...
                                <li>
                                    <a href="http://208.113.130.107:8069/web">Login</a>
                                </li>
                                <li>
                                    <a href="cform.html">Register</a>
                                </li>
                            </ul>
                        </div>
                </div>
            ...
            <div id="wrapper">
                <div class="frm loginFrmSection brd-rad">
                    ...
                    <div class="frmArea">
                        ...
                        <form id="merchantCreateForm" method="POST" class="cbt-form myForm" name="create" action="upload.php">
                            ...
                            <div class="cbt-form-row cbt-form-required">
                                <label for="merchant_password" class="label">Password:<em>&nbsp;*</em>
                                </label>
                            ...
                            <div class="cbt-form-row cbt-form-required">
                                <label for="merchant_confirm_password" class="label">Confirm Password:<em>&nbsp;*</em>
                                </label>
                            ...
                            <div class="cbt-form-row cbt-form-required">
                                <label for="merchant_phone" class="label">Phone:<em>&nbsp;*</em>
                                </label>
                            ...
                            <div class="cbt-form-row cbt-form-required">
                                <label for="merchant_phone" class="label">
                                </label>
                            ...
                            <div class="cbt-form-row cbt-form-required" id="create-submit">
                                <div class="login-btn fl">
                                    <input type="submit" class="cbt-btn" value="Register" id="createButton">
                                </div>
                                <div class="fl">
                                    <span class="cbt-loading cbt-hide">
                                    </span>
                                </div>
                                <div class="clear">&nbsp;</div>
                            </div>
                ...
                <div class="cbt-popover cbt-bubble cbt-box-icon cbt-box-error cbt-cone" role="alert" id="cbt-merchant-email-exists" aria-hidden="false" data-side="right" data-align="top">
                    <i class="cbt-icon-remove-sign">
                    </i>
                    <div class="cbt-popover-content">Email already exists.</div>
                </div>
                <div class="cbt-popover cbt-bubble cbt-box-icon cbt-box-error cbt-cone" role="alert" id="cbt-merchant-name-exists" aria-hidden="false" data-side="right" data-align="top">
                    <i class="cbt-icon-remove-sign">
                    </i>
                    <div class="cbt-popover-content">display name already exists.</div>
                </div>
            </div>
        </div>
        <footer class="content-footer">
            <div class="content">
                ...
                <ul class="each-footer-links">
                    <li>
                        <a href="http://investor.mercadolibre.com/">Investor Relations</a>
                    </li>
                    <li class="last-footer">
                        <a href="/us/merchant/cbt-merchant-agreement/">Terms and Conditions</a>
                    </li>
                    <li class="last-footer">
                        <a href="/us/merchant/faqs/">FAQs</a>
                    </li>
                </ul>

                <div class="copyright">
                    <p>Copyright © 2016 Caring Trading and Logistics Limited</p>
                </div>

            </div>
        </footer>
        <script type="text/javascript" src="//static-cbt.mercadolibre.com/js/jquery-1.8.0.min.js">
        </script>
